 ...
 * @param {number} len
 */
DataView.prototype.setBinaryString = function SetBinaryString(
	offset,
	str,
	len
) {
 ...
 * @return {BinaryWriter}
 */
BinaryWriter.prototype.setInt16 = BinaryWriter.prototype.writeShort =
	function setInt16(value) {
 ...
 * @return {BinaryWriter}
 */
BinaryWriter.prototype.setUint16 = BinaryWriter.prototype.writeUShort =
 ...
 * @return {BinaryWriter}
 */
BinaryWriter.prototype.setFloat32 = BinaryWriter.prototype.writeFloat =
	function setFloat32(value) {
 ...
 * @return {BinaryWriter}
 */
BinaryWriter.prototype.setFloat64 = BinaryWriter.prototype.writeDouble =
	function setFloat64(value) {
 ...
 * @return {BinaryWriter}
 */
BinaryWriter.prototype.setString = BinaryWriter.prototype.writeString =
	function setString(str, length) {
		if (length) {
		...
		if (!length && data.length > str.length) {
			...
			var uint8 = new Uint8Array(
				this.buffer.byteLength + (data.length - str.length)
			);
...
BinaryWriter.prototype.setBinaryString =
	BinaryWriter.prototype.writeBinaryString = function setBinaryString(
		str,
		length
	) {
		if (length) {
 ...
 * @return {BinaryWriter}
 */
BinaryWriter.prototype.setBuffer = BinaryWriter.prototype.writeBuffer =
 ...
 * @return {BinaryWriter}
 */
BinaryWriter.prototype.setPos = BinaryWriter.prototype.writePos =
	function setPos(xy) {
		var x = xy[0],
			y = xy[1];

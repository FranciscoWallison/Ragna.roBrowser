...
// 0xeb
PACKET.CZ.CONCLUDE_EXCHANGE_ITEM =
...
// 0x126
PACKET.CZ.MOVE_ITEM_FROM_BODY_TO_CART =
...
// 0x127
PACKET.CZ.MOVE_ITEM_FROM_CART_TO_BODY =
...
// 0x128
PACKET.CZ.MOVE_ITEM_FROM_STORE_TO_CART =
...
// 0x129
PACKET.CZ.MOVE_ITEM_FROM_CART_TO_STORE =
...
// 0x134
PACKET.CZ.PC_PURCHASE_ITEMLIST_FROMMC =
...
// 0x14d
PACKET.CZ.REQ_GUILD_MENUINTERFACE =
...
// 0x153
PACKET.CZ.REGISTER_GUILD_EMBLEM_IMG =
...
// 0x161
PACKET.CZ.REG_CHANGE_GUILD_POSITIONINFO =
...
// 0x17a
PACKET.CZ.REQ_ITEMCOMPOSITION_LIST =
...
// 0x183
PACKET.CZ.REQ_DELETE_RELATED_GUILD =
...
PACKET.CZ.USE_SKILL_TOGROUNDMoreInfo =
	function PACKET_CZ_USE_SKILL_TOGROUND_MoreInfo() {
		this.selectedLevel = 0;
		this.SKID = 0;
		this.xPos = 0;
		this.yPos = 0;
...
// 0x25d
PACKET.CZ.AUCTION_REQ_MY_SELL_STOP =
...
// 0x28c
PACKET.CH.SELECT_CHAR_GOINGTOBEUSED =
...
// 0x2a1
UNUSED_PACKET.CZ.MER_UPGRADE_SKILLLEVEL =
...
// 0x2cf
PACKET.CZ.MEMORIALDUNGEON_COMMAND =
...
// 0x35c
PACKET.CZ.OPEN_SIMPLE_CASHSHOP_ITEMLIST =
...
// 0x364
PACKET.CZ.MOVE_ITEM_FROM_BODY_TO_STORE2 =
...
// 0x365
PACKET.CZ.MOVE_ITEM_FROM_STORE_TO_BODY2 =
...
// 0x445
PACKET.CZ.SIMPLE_BUY_CASH_POINT_ITEM =
...
// 0x7f0
PACKET.CZ.REQ_BATTLE_STATE_MONITOR =
...
// 0x801
PACKET.CZ.PC_PURCHASE_ITEMLIST_FROMMC2 =
...
// 0x802
PACKET.CZ.PARTY_BOOKING_REQ_REGISTER =
...
// 0x804
PACKET.CZ.PARTY_BOOKING_REQ_SEARCH =
...
// 0x806
PACKET.CZ.PARTY_BOOKING_REQ_DELETE =
...
// 0x808
PACKET.CZ.PARTY_BOOKING_REQ_UPDATE =
...
// 0x815
PACKET.CZ.REQ_CLOSE_BUYING_STORE =
...
// 0x817
PACKET.CZ.REQ_CLICK_TO_BUYING_STORE =
...
//0x08ca
PACKET.ZC.ACK_SCHEDULER_CASHITEM = function PACKET_ZC_ACK_SCHEDULER_CASHITEM(
	fp,
	end
) {
...
//0x08c0
PACKET.ZC.ACK_SE_CASH_ITEM_LIST2 = function PACKET_ZC_ACK_SE_CASH_ITEM_LIST2(
	fp,
	end
) {
...
//0x08c9
PACKET.CZ.PC_CASH_POINT_ITEMLIST =
	function PACKET_CZ_PC_CASH_POINT_ITEMLIST() {};
...
PACKET.CZ.SE_PC_BUY_CASHITEM_LIST =
...
//0x0849
PACKET.ZC.SE_PC_BUY_CASHITEM_RESULT =
	function PACKET_ZC_SE_PC_BUY_CASHITEM_RESULT(fp, end) {
		this.kafraPoints = fp.readUShort();
...
PACKET.CZ.SEARCH_STORE_INFO.prototype.build = function () {
	...
	pkt.view.setInt16(
		...
		2 +
			...
			1 +
			1 +
			this.ItemIDList.length * 2 +
			this.CardIDList.length * 2,
		true
	);
...
// 0x838
PACKET.CZ.SEARCH_STORE_INFO_NEXT_PAGE =
...
// 0x83b
PACKET.CZ.CLOSE_SEARCH_STORE_INFO =
...
// 0x841
PACKET.CH.SELECT_ACCESSIBLE_MAPNAME =
...
// 0x6b
PACKET.HC.ACCEPT_ENTER_NEO_UNION = function PACKET_HC_ACCEPT_ENTER_NEO_UNION(
	fp,
	end
) {
...
// 0x6d
PACKET.HC.ACCEPT_MAKECHAR_NEO_UNION =
	function PACKET_HC_ACCEPT_MAKECHAR_NEO_UNION(fp, end) {
...
// 0x77
PACKET.ZC.NOTIFY_UPDATEPLAYER = function PACKET_ZC_NOTIFY_UPDATEPLAYER(
	fp,
	end
) {
	this.Style = fp.readShort();
...
// 0x7c
PACKET.ZC.NOTIFY_STANDENTRY_NPC = function PACKET_ZC_NOTIFY_STANDENTRY_NPC(
	fp,
	end
) {
	this.objecttype = fp.readUChar();
...
// 0x8b
PACKET.ZC.NOTIFY_ACT_POSITION = function PACKET_ZC_NOTIFY_ACT_POSITION(
	fp,
	end
) {
	this.GID = fp.readULong();
...
// 0xa5
PACKET.ZC.STORE_NORMAL_ITEMLIST = function PACKET_ZC_STORE_NORMAL_ITEMLIST(
	fp,
	end
) {
	this.itemInfo = (function () {
...
// 0xa6
PACKET.ZC.STORE_EQUIPMENT_ITEMLIST =
	function PACKET_ZC_STORE_EQUIPMENT_ITEMLIST(fp, end) {
		this.itemInfo = (function () {
			var i,
				count = ((end - fp.tell()) / 20) | 0,
				out = new Array(count);
...
// 0xac
PACKET.ZC.REQ_TAKEOFF_EQUIP_ACK = function PACKET_ZC_REQ_TAKEOFF_EQUIP_ACK(
	fp,
	end
) {
	this.index = fp.readUShort();
...
// 0xc6
PACKET.ZC.PC_PURCHASE_ITEMLIST = function PACKET_ZC_PC_PURCHASE_ITEMLIST(
	fp,
	end
) {
	this.itemList = (function () {
		...
		for (i = 0; i < count; ++i) {
			...
			out[i].type = fp.readUChar();
			out[i].ITID =
				PACKETVER.value >= 20181121 ? fp.readULong() : fp.readUShort();
		}
		return out;
	})();
};
...
// 0xcd
PACKET.ZC.ACK_DISCONNECT_CHARACTER =
	function PACKET_ZC_ACK_DISCONNECT_CHARACTER(fp, end) {
		this.result = fp.readUChar();
	};
...
// 0xd2
PACKET.ZC.SETTING_WHISPER_STATE = function PACKET_ZC_SETTING_WHISPER_STATE(
	fp,
	end
) {
	this.type = fp.readUChar();
...
// 0xd6
PACKET.ZC.ACK_CREATE_CHATROOM = function PACKET_ZC_ACK_CREATE_CHATROOM(
	fp,
	end
) {
	this.result = fp.readUChar();
...
// 0xea
PACKET.ZC.ACK_ADD_EXCHANGE_ITEM = function PACKET_ZC_ACK_ADD_EXCHANGE_ITEM(
	fp,
	end
) {
...
// 0xec
PACKET.ZC.CONCLUDE_EXCHANGE_ITEM = function PACKET_ZC_CONCLUDE_EXCHANGE_ITEM(
	fp,
	end
) {
...
// 0xee
PACKET.ZC.CANCEL_EXCHANGE_ITEM = function PACKET_ZC_CANCEL_EXCHANGE_ITEM(
	fp,
	end
) {};
...
// 0xf2
PACKET.ZC.NOTIFY_STOREITEM_COUNTINFO =
	function PACKET_ZC_NOTIFY_STOREITEM_COUNTINFO(fp, end) {
		this.curCount = fp.readShort();
		this.maxCount = fp.readShort();
	};
...
// 0xf6
PACKET.ZC.DELETE_ITEM_FROM_STORE = function PACKET_ZC_DELETE_ITEM_FROM_STORE(
	fp,
	end
) {
	this.index = fp.readShort();
...
// 0x104
PACKET.ZC.ADD_MEMBER_TO_GROUP = function PACKET_ZC_ADD_MEMBER_TO_GROUP(
	fp,
	end
) {
	this.AID = fp.readULong();
...
// 0x105
PACKET.ZC.DELETE_MEMBER_FROM_GROUP =
	function PACKET_ZC_DELETE_MEMBER_FROM_GROUP(fp, end) {
		this.AID = fp.readULong();
		this.characterName = fp.readString(NAME_LENGTH);
		this.result = fp.readUChar();
	};
...
// 0x106
PACKET.ZC.NOTIFY_HP_TO_GROUPM = function PACKET_ZC_NOTIFY_HP_TO_GROUPM(
	fp,
	end
) {
	this.AID = fp.readULong();
...
// 0x107
PACKET.ZC.NOTIFY_POSITION_TO_GROUPM =
	function PACKET_ZC_NOTIFY_POSITION_TO_GROUPM(fp, end) {
		this.AID = fp.readULong();
		this.xPos = fp.readShort();
		this.yPos = fp.readShort();
	};
...
// 0x10b
PACKET.ZC.MVP_GETTING_SPECIAL_EXP = function PACKET_ZC_MVP_GETTING_SPECIAL_EXP(
	fp,
	end
) {
...
PACKET.ZC.ACK_TOUSESKILL = function PACKET_ZC_ACK_TOUSESKILL(fp, end) {
	this.SKID = fp.readUShort();
	if (
		(CLASSIC && PACKETVER.value >= 20181121) ||
		(RENEWAL && PACKETVER.value >= 20180704)
	) {
...
// 0x115
PACKET.ZC.NOTIFY_SKILL_POSITION = function PACKET_ZC_NOTIFY_SKILL_POSITION(
	fp,
	end
) {
	this.SKID = fp.readUShort();
...
// 0x11e
PACKET.ZC.ACK_REMEMBER_WARPPOINT = function PACKET_ZC_ACK_REMEMBER_WARPPOINT(
	fp,
	end
) {
	this.errorCode = fp.readUChar();
...
// 0x121
PACKET.ZC.NOTIFY_CARTITEM_COUNTINFO =
	function PACKET_ZC_NOTIFY_CARTITEM_COUNTINFO(fp, end) {
		this.curCount = fp.readShort();
		this.maxCount = fp.readShort();
...
// 0x122
PACKET.ZC.CART_EQUIPMENT_ITEMLIST = function PACKET_ZC_CART_EQUIPMENT_ITEMLIST(
	fp,
	end
) {
	this.itemInfo = (function () {
...
// 0x123
PACKET.ZC.CART_NORMAL_ITEMLIST = function PACKET_ZC_CART_NORMAL_ITEMLIST(
	fp,
	end
) {
	this.itemInfo = (function () {
...
// 0x125
PACKET.ZC.DELETE_ITEM_FROM_CART = function PACKET_ZC_DELETE_ITEM_FROM_CART(
	fp,
	end
) {
	this.index = fp.readShort();
...
// 0x12c
PACKET.ZC.ACK_ADDITEM_TO_CART = function PACKET_ZC_ACK_ADDITEM_TO_CART(
	fp,
	end
) {
	this.result = fp.readUChar();
...
// 0x133
PACKET.ZC.PC_PURCHASE_ITEMLIST_FROMMC =
	function PACKET_ZC_PC_PURCHASE_ITEMLIST_FROMMC(fp, end) {
		this.AID = fp.readULong();
		this.itemList = (function () {
			var i,
...
// 0x135
PACKET.ZC.PC_PURCHASE_RESULT_FROMMC =
	function PACKET_ZC_PC_PURCHASE_RESULT_FROMMC(fp, end) {
		this.index = fp.readShort();
		this.curcount = fp.readShort();
		this.result = fp.readUChar();
	};
...
// 0x136
PACKET.ZC.PC_PURCHASE_MYITEMLIST = function PACKET_ZC_PC_PURCHASE_MYITEMLIST(
	fp,
	end
) {
...
// 0x137
PACKET.ZC.DELETEITEM_FROM_MCSTORE = function PACKET_ZC_DELETEITEM_FROM_MCSTORE(
	fp,
	end
) {
	this.index = fp.readShort();
...
// 0x139
PACKET.ZC.ATTACK_FAILURE_FOR_DISTANCE =
	function PACKET_ZC_ATTACK_FAILURE_FOR_DISTANCE(fp, end) {
		this.targetAID = fp.readULong();
...
// 0x14a
PACKET.ZC.ACK_GIVE_MANNER_POINT = function PACKET_ZC_ACK_GIVE_MANNER_POINT(
	fp,
	end
) {
...
// 0x14b
PACKET.ZC.NOTIFY_MANNER_POINT_GIVEN =
	function PACKET_ZC_NOTIFY_MANNER_POINT_GIVEN(fp, end) {
		this.type = fp.readUChar();
...
// 0x14e
PACKET.ZC.ACK_GUILD_MENUINTERFACE = function PACKET_ZC_ACK_GUILD_MENUINTERFACE(
	fp,
	end
) {
...
// 0x156
PACKET.ZC.ACK_REQ_CHANGE_MEMBERS = function PACKET_ZC_ACK_REQ_CHANGE_MEMBERS(
	fp,
	end
) {
	this.memberInfo = (function () {
...
// 0x158
PACKET.ZC.ACK_OPEN_MEMBER_INFO = function PACKET_ZC_ACK_OPEN_MEMBER_INFO(
	fp,
	end
) {};
...
// 0x15e
PACKET.ZC.ACK_DISORGANIZE_GUILD_RESULT =
	function PACKET_ZC_ACK_DISORGANIZE_GUILD_RESULT(fp, end) {
		this.reason = fp.readLong();
	};
PACKET.ZC.ACK_DISORGANIZE_GUILD_RESULT.size = 6;

// 0x15f
PACKET.ZC.ACK_DISORGANIZE_GUILD = function PACKET_ZC_ACK_DISORGANIZE_GUILD(
	fp,
	end
) {
	this.reasonDesc = fp.readString(40);
...
// 0x166
PACKET.ZC.POSITION_ID_NAME_INFO = function PACKET_ZC_POSITION_ID_NAME_INFO(
	fp,
	end
) {
	this.memberList = (function () {
...
// 0x174
PACKET.ZC.ACK_CHANGE_GUILD_POSITIONINFO =
	function PACKET_ZC_ACK_CHANGE_GUILD_POSITIONINFO(fp, end) {
		this.memberList = (function () {
			var i,
...
// 0x176
PACKET.ZC.ACK_GUILD_MEMBER_INFO = function PACKET_ZC_ACK_GUILD_MEMBER_INFO(
	fp,
	end
) {
	this.Info = {};
...
// 0x17b
PACKET.ZC.ITEMCOMPOSITION_LIST = function PACKET_ZC_ITEMCOMPOSITION_LIST(
	fp,
	end
) {
	this.ITIDList = (function () {
...
// 0x17d
PACKET.ZC.ACK_ITEMCOMPOSITION = function PACKET_ZC_ACK_ITEMCOMPOSITION(
	fp,
	end
) {
...
// 0x181
PACKET.ZC.ACK_REQ_HOSTILE_GUILD = function PACKET_ZC_ACK_REQ_HOSTILE_GUILD(
	fp,
	end
) {
	this.result = fp.readUChar();
...
// 0x184
PACKET.ZC.DELETE_RELATED_GUILD = function PACKET_ZC_DELETE_RELATED_GUILD(
	fp,
	end
) {
...
// 0x191
PACKET.ZC.TALKBOX_CHATCONTENTS = function PACKET_ZC_TALKBOX_CHATCONTENTS(
	fp,
	end
) {
	this.AID = fp.readULong();
...
// 0x1d6
PACKET.ZC.NOTIFY_MAPPROPERTY2 = function PACKET_ZC_NOTIFY_MAPPROPERTY2(
	fp,
	end
) {
	this.type = fp.readShort();
...
// 0x1e9
PACKET.ZC.ADD_MEMBER_TO_GROUP2 = function PACKET_ZC_ADD_MEMBER_TO_GROUP2(
	fp,
	end
) {
	this.AID = fp.readULong();
...
// 0x1eb
PACKET.ZC.NOTIFY_POSITION_TO_GUILDM =
	function PACKET_ZC_NOTIFY_POSITION_TO_GUILDM(fp, end) {
		this.AID = fp.readULong();
		this.xPos = fp.readShort();
		this.yPos = fp.readShort();
	};
...
// 0x1ec
PACKET.ZC.GUILD_MEMBER_MAP_CHANGE = function PACKET_ZC_GUILD_MEMBER_MAP_CHANGE(
	fp,
	end
) {
	this.GDID = fp.readULong();
...
// 0x1ef
PACKET.ZC.CART_NORMAL_ITEMLIST2 = function PACKET_ZC_CART_NORMAL_ITEMLIST2(
	fp,
	end
) {
	this.ItemInfo = (function () {
...
// 0x1f0
PACKET.ZC.STORE_NORMAL_ITEMLIST2 = function PACKET_ZC_STORE_NORMAL_ITEMLIST2(
	fp,
	end
) {
	this.ItemInfo = (function () {
...
// 0x221
PACKET.ZC.NOTIFY_WEAPONITEMLIST = function PACKET_ZC_NOTIFY_WEAPONITEMLIST(
	fp,
	end
) {
	this.itemList = (function () {
...
// 0x23c
PACKET.ZC.RESULT_STORE_PASSWORD = function PACKET_ZC_RESULT_STORE_PASSWORD(
	fp,
	end
) {
	this.Result = fp.readShort();
...
// 0x23e
PACKET.HC.REQUEST_CHARACTER_PASSWORD =
	function PACKET_HC_REQUEST_CHARACTER_PASSWORD(fp, end) {
		this.Result = fp.readShort();
...
// 0x252
PACKET.ZC.AUCTION_ITEM_REQ_SEARCH = function PACKET_ZC_AUCTION_ITEM_REQ_SEARCH(
	fp,
	end
) {
...
// 0x256
PACKET.ZC.ACK_AUCTION_ADD_ITEM = function PACKET_ZC_ACK_AUCTION_ADD_ITEM(
	fp,
	end
) {
	this.Index = fp.readShort();
...
// 0x25e
PACKET.ZC.AUCTION_ACK_MY_SELL_STOP =
	function PACKET_ZC_AUCTION_ACK_MY_SELL_STOP(fp, end) {
		this.Result = fp.readShort();
	};
...
// 0x267
PACKET.AC.ACK_EKEY_FAIL_NOTEXIST = function PACKET_AC_ACK_EKEY_FAIL_NOTEXIST(
	fp,
	end
) {
	this.errorCode = fp.readShort();
...
// 0x268
PACKET.AC.ACK_EKEY_FAIL_NOTUSESEKEY =
	function PACKET_AC_ACK_EKEY_FAIL_NOTUSESEKEY(fp, end) {
		this.errorCode = fp.readShort();
	};
PACKET.AC.ACK_EKEY_FAIL_NOTUSESEKEY.size = 4;

// 0x269
PACKET.AC.ACK_EKEY_FAIL_NOTUSEDEKEY =
	function PACKET_AC_ACK_EKEY_FAIL_NOTUSEDEKEY(fp, end) {
		this.errorCode = fp.readShort();
	};
PACKET.AC.ACK_EKEY_FAIL_NOTUSEDEKEY.size = 4;

// 0x26a
PACKET.AC.ACK_EKEY_FAIL_AUTHREFUSE =
	function PACKET_AC_ACK_EKEY_FAIL_AUTHREFUSE(fp, end) {
		this.errorCode = fp.readShort();
	};
PACKET.AC.ACK_EKEY_FAIL_AUTHREFUSE.size = 4;

// 0x26b
PACKET.AC.ACK_EKEY_FAIL_INPUTEKEY = function PACKET_AC_ACK_EKEY_FAIL_INPUTEKEY(
	fp,
	end
) {
	this.errorCode = fp.readShort();
...
// 0x26c
PACKET.AC.ACK_EKEY_FAIL_NOTICE = function PACKET_AC_ACK_EKEY_FAIL_NOTICE(
	fp,
	end
) {
	this.errorCode = fp.readShort();
...
// 0x26d
PACKET.AC.ACK_EKEY_FAIL_NEEDCARDPASS =
	function PACKET_AC_ACK_EKEY_FAIL_NEEDCARDPASS(fp, end) {
		this.errorCode = fp.readShort();
	};
PACKET.AC.ACK_EKEY_FAIL_NEEDCARDPASS.size = 4;

// 0x26e
PACKET.AC.ACK_AUTHEKEY_FAIL_NOTMATCHCARDPASS =
	function PACKET_AC_ACK_AUTHEKEY_FAIL_NOTMATCHCARDPASS(fp, end) {
		this.errorCode = fp.readShort();
	};
...
// 0x270
PACKET.AC.REQ_LOGIN_ACCOUNT_INFO = function PACKET_AC_REQ_LOGIN_ACCOUNT_INFO(
	fp,
	end
) {};
...
// 0x287
PACKET.ZC.PC_CASH_POINT_ITEMLIST = function PACKET_ZC_PC_CASH_POINT_ITEMLIST(
	fp,
	end
) {
...
// 0x289
PACKET.ZC.PC_CASH_POINT_UPDATE = function PACKET_ZC_PC_CASH_POINT_UPDATE(
	fp,
	end
) {
	this.KafraPoint = fp.readULong();
...
// 0x28a
PACKET.ZC.NPC_SHOWEFST_UPDATE = function PACKET_ZC_NPC_SHOWEFST_UPDATE(
	fp,
	end
) {
	this.AID = fp.readULong();
...
// 0x28e
PACKET.HC.ACK_IS_VALID_CHARNAME = function PACKET_HC_ACK_IS_VALID_CHARNAME(
	fp,
	end
) {
...
// 0x290
PACKET.HC.ACK_CHANGE_CHARNAME = function PACKET_HC_ACK_CHANGE_CHARNAME(
	fp,
	end
) {
	this.sResult = fp.readShort();
...
// 0x295
PACKET.ZC.EQUIPMENT_ITEMLIST2 = function PACKET_ZC_EQUIPMENT_ITEMLIST2(
	fp,
	end
) {
	this.ItemInfo = (function () {
...
// 0x296
PACKET.ZC.STORE_EQUIPMENT_ITEMLIST2 =
	function PACKET_ZC_STORE_EQUIPMENT_ITEMLIST2(fp, end) {
		this.ItemInfo = (function () {
			var i,
				count = ((end - fp.tell()) / 24) | 0,
				out = new Array(count);
...
// 0x297
PACKET.ZC.CART_EQUIPMENT_ITEMLIST2 =
	function PACKET_ZC_CART_EQUIPMENT_ITEMLIST2(fp, end) {
		this.ItemInfo = (function () {
			var i,
				count = ((end - fp.tell()) / 24) | 0,
				out = new Array(count);
...
PACKET.ZC.PERSONAL_INFOMATION = function PACKET_ZC_PERSONAL_INFOMATION(
	fp,
	end
) {
	this.info = (function () {
...
// 0x29e
PACKET.ZC.MER_SKILLINFO_UPDATE = function PACKET_ZC_MER_SKILLINFO_UPDATE(
	fp,
	end
) {
	this.SKID = fp.readUShort();
...
// 0x2a3
PACKET.ZC.GAMEGUARD_LINGO_KEY = function PACKET_ZC_GAMEGUARD_LINGO_KEY(
	fp,
	end
) {
...
// 0x2ac
PACKET.ZC.RESULT_CASH_PASSWORD = function PACKET_ZC_RESULT_CASH_PASSWORD(
	fp,
	end
) {
	this.Result = fp.readShort();
...
// 0x2ad
PACKET.AC.REQUEST_SECOND_PASSWORD = function PACKET_AC_REQUEST_SECOND_PASSWORD(
	fp,
	end
) {
	this.Result = fp.readShort();
...
// 0x2b5
PACKET.ZC.UPDATE_MISSION_HUNT = function PACKET_ZC_UPDATE_MISSION_HUNT(
	fp,
	end
) {
...
// 0x2bc
PACKET.ZC.NOTIFY_PCBANG_PLAYING_TIME =
	function PACKET_ZC_NOTIFY_PCBANG_PLAYING_TIME(fp, end) {
...
// 0x2cb
PACKET.ZC.MEMORIALDUNGEON_SUBSCRIPTION_INFO =
	function PACKET_ZC_MEMORIALDUNGEON_SUBSCRIPTION_INFO(fp, end) {
...
// 0x2cc
PACKET.ZC.MEMORIALDUNGEON_SUBSCRIPTION_NOTIFY =
	function PACKET_ZC_MEMORIALDUNGEON_SUBSCRIPTION_NOTIFY(fp, end) {
		this.PriorityOrderNum = fp.readShort();
	};
PACKET.ZC.MEMORIALDUNGEON_SUBSCRIPTION_NOTIFY.size = 4;

// 0x2cd
PACKET.ZC.MEMORIALDUNGEON_INFO = function PACKET_ZC_MEMORIALDUNGEON_INFO(
	fp,
	end
) {
	this.MemorialDungeonName = fp.readString(61);
...
// 0x2ce
PACKET.ZC.MEMORIALDUNGEON_NOTIFY = function PACKET_ZC_MEMORIALDUNGEON_NOTIFY(
	fp,
	end
) {
	this.Type = fp.readLong();
...
// 0x2d0
PACKET.ZC.EQUIPMENT_ITEMLIST3 = function PACKET_ZC_EQUIPMENT_ITEMLIST3(
	fp,
	end
) {
	this.ItemInfo = (function () {
...
// 0x2d1
PACKET.ZC.STORE_EQUIPMENT_ITEMLIST3 =
	function PACKET_ZC_STORE_EQUIPMENT_ITEMLIST3(fp, end) {
		this.ItemInfo = (function () {
			var i,
				count = ((end - fp.tell()) / 28) | 0,
				out = new Array(count);
...
// 0x2d2
PACKET.ZC.CART_EQUIPMENT_ITEMLIST3 =
	function PACKET_ZC_CART_EQUIPMENT_ITEMLIST3(fp, end) {
		this.ItemInfo = (function () {
			var i,
				count = ((end - fp.tell()) / 28) | 0,
				out = new Array(count);
...
// 0x2d3
PACKET.ZC.NOTIFY_BIND_ON_EQUIP = function PACKET_ZC_NOTIFY_BIND_ON_EQUIP(
	fp,
	end
) {
	this.index = fp.readUShort();
...
// 0x2d7
PACKET.ZC.EQUIPWIN_MICROSCOPE = function PACKET_ZC_EQUIPWIN_MICROSCOPE(
	fp,
	end
) {
	this.characterName = fp.readString(NAME_LENGTH);
...
// 0x2dd
PACKET.ZC.BATTLEFIELD_NOTIFY_CAMPINFO =
	function PACKET_ZC_BATTLEFIELD_NOTIFY_CAMPINFO(fp, end) {
		this.accountID = fp.readULong();
		this.name = fp.readString(NAME_LENGTH);
...
// 0x2de
PACKET.ZC.BATTLEFIELD_NOTIFY_POINT =
	function PACKET_ZC_BATTLEFIELD_NOTIFY_POINT(fp, end) {
...
// 0x2df
PACKET.ZC.BATTLEFIELD_NOTIFY_POSITION =
	function PACKET_ZC_BATTLEFIELD_NOTIFY_POSITION(fp, end) {
		this.accountID = fp.readULong();
		this.name = fp.readString(NAME_LENGTH);
...
// 0x2e0
PACKET.ZC.BATTLEFIELD_NOTIFY_HP = function PACKET_ZC_BATTLEFIELD_NOTIFY_HP(
	fp,
	end
) {
	this.accountID = fp.readULong();
...
// 0x2e9
PACKET.ZC.CART_NORMAL_ITEMLIST3 = function PACKET_ZC_CART_NORMAL_ITEMLIST3(
	fp,
	end
) {
	this.ItemInfo = (function () {
...
// 0x2ea
PACKET.ZC.STORE_NORMAL_ITEMLIST3 = function PACKET_ZC_STORE_NORMAL_ITEMLIST3(
	fp,
	end
) {
	this.ItemInfo = (function () {
...
// 0x35d
PACKET.ZC.SIMPLE_CASHSHOP_POINT_ITEMLIST =
	function PACKET_ZC_SIMPLE_CASHSHOP_POINT_ITEMLIST(fp, end) {
		this.CashPoint = fp.readULong();
...
// 0x43e
PACKET.ZC.SKILL_POSTDELAY_LIST = function PACKET_ZC_SKILL_POSTDELAY_LIST(
	fp,
	end
) {
...
// 0x442
PACKET.ZC.SKILL_SELECT_REQUEST = function PACKET_ZC_SKILL_SELECT_REQUEST(
	fp,
	end
) {
...
// 0x444
PACKET.ZC.SIMPLE_CASH_POINT_ITEMLIST =
	function PACKET_ZC_SIMPLE_CASH_POINT_ITEMLIST(fp, end) {
		this.CashPoint = fp.readULong();
		this.ItemList = (function () {
			var i,
				count = ((end - fp.tell()) / 11) | 0,
...
// 0x446
PACKET.ZC.QUEST_NOTIFY_EFFECT = function PACKET_ZC_QUEST_NOTIFY_EFFECT(
	fp,
	end
) {
...
// 0x7d8
PACKET.ZC.REQ_GROUPINFO_CHANGE_V2 = function PACKET_ZC_REQ_GROUPINFO_CHANGE_V2(
	fp,
	end
) {
	this.expOption = fp.readULong();
...
// 0x7d9
PACKET.ZC.SHORTCUT_KEY_LIST_V2 = function PACKET_ZC_SHORTCUT_KEY_LIST_V2(
	fp,
	end
) {
	this.ShortCutKey = (function () {
...
// 0x7ef
PACKET.ZC.CANCEL_BATTLE_FIELD = function PACKET_ZC_CANCEL_BATTLE_FIELD(
	fp,
	end
) {
	this.BFNO = fp.readULong();
...
// 0x7f1
PACKET.ZC.ACK_BATTLE_STATE_MONITOR =
	function PACKET_ZC_ACK_BATTLE_STATE_MONITOR(fp, end) {
		this.BFNO = fp.readULong();
...
// 0x7f2
PACKET.ZC.BATTLE_NOTI_START_STEP = function PACKET_ZC_BATTLE_NOTI_START_STEP(
	fp,
	end
) {
	this.BFNO = fp.readULong();
...
// 0x7f3
PACKET.ZC.BATTLE_JOIN_NOTI_DEFER = function PACKET_ZC_BATTLE_JOIN_NOTI_DEFER(
	fp,
	end
) {
	this.BFNO = fp.readULong();
...
// 0x7f4
PACKET.ZC.BATTLE_JOIN_DISABLE_STATE =
	function PACKET_ZC_BATTLE_JOIN_DISABLE_STATE(fp, end) {
...
// 0x7fa
PACKET.ZC.DELETE_ITEM_FROM_BODY = function PACKET_ZC_DELETE_ITEM_FROM_BODY(
	fp,
	end
) {
...
// 0x7fc
PACKET.ZC.CHANGE_GROUP_MASTER = function PACKET_ZC_CHANGE_GROUP_MASTER(
	fp,
	end
) {
...
// 0x800
PACKET.ZC.PC_PURCHASE_ITEMLIST_FROMMC2 =
	function PACKET_ZC_PC_PURCHASE_ITEMLIST_FROMMC2(fp, end) {
		this.AID = fp.readULong();
...
// 0x803
PACKET.ZC.PARTY_BOOKING_ACK_REGISTER =
	function PACKET_ZC_PARTY_BOOKING_ACK_REGISTER(fp, end) {
		this.Result = fp.readShort();
	};
PACKET.ZC.PARTY_BOOKING_ACK_REGISTER.size = 4;

// 0x805
PACKET.ZC.PARTY_BOOKING_ACK_SEARCH =
	function PACKET_ZC_PARTY_BOOKING_ACK_SEARCH(fp, end) {
...
// 0x807
PACKET.ZC.PARTY_BOOKING_ACK_DELETE =
	function PACKET_ZC_PARTY_BOOKING_ACK_DELETE(fp, end) {
		this.Result = fp.readShort();
	};
PACKET.ZC.PARTY_BOOKING_ACK_DELETE.size = 4;

// 0x809
PACKET.ZC.PARTY_BOOKING_NOTIFY_INSERT =
	function PACKET_ZC_PARTY_BOOKING_NOTIFY_INSERT(fp, end) {
		this.Info = {};
...
// 0x80a
PACKET.ZC.PARTY_BOOKING_NOTIFY_UPDATE =
	function PACKET_ZC_PARTY_BOOKING_NOTIFY_UPDATE(fp, end) {
...
// 0x80b
PACKET.ZC.PARTY_BOOKING_NOTIFY_DELETE =
	function PACKET_ZC_PARTY_BOOKING_NOTIFY_DELETE(fp, end) {
		this.Index = fp.readULong();
	};
PACKET.ZC.PARTY_BOOKING_NOTIFY_DELETE.size = 6;

// 0x80d
PACKET.ZC.SIMPLE_CASH_BTNSHOW = function PACKET_ZC_SIMPLE_CASH_BTNSHOW(
	fp,
	end
) {
...
// 0x80e
PACKET.ZC.NOTIFY_HP_TO_GROUPM_R2 = function PACKET_ZC_NOTIFY_HP_TO_GROUPM_R2(
	fp,
	end
) {
	this.AID = fp.readULong();
...
// 0x812
PACKET.ZC.FAILED_OPEN_BUYING_STORE_TO_BUYER =
	function PACKET_ZC_FAILED_OPEN_BUYING_STORE_TO_BUYER(fp, end) {
		this.Result = fp.readShort();
...
// 0x813
PACKET.ZC.MYITEMLIST_BUYING_STORE = function PACKET_ZC_MYITEMLIST_BUYING_STORE(
	fp,
	end
) {
...
// 0x816
PACKET.ZC.DISAPPEAR_BUYING_STORE_ENTRY =
	function PACKET_ZC_DISAPPEAR_BUYING_STORE_ENTRY(fp, end) {
		this.makerAID = fp.readULong();
	};
PACKET.ZC.DISAPPEAR_BUYING_STORE_ENTRY.size = 6;

// 0x818
PACKET.ZC.ACK_ITEMLIST_BUYING_STORE =
	function PACKET_ZC_ACK_ITEMLIST_BUYING_STORE(fp, end) {
		this.AID = fp.readULong();
		this.UniqueID = fp.readULong();
		this.limitZeny = fp.readLong();
		this.itemList = (function () {
...
// 0x81a
PACKET.ZC.FAILED_TRADE_BUYING_STORE_TO_BUYER =
	function PACKET_ZC_FAILED_TRADE_BUYING_STORE_TO_BUYER(fp, end) {
		this.Result = fp.readShort();
	};
PACKET.ZC.FAILED_TRADE_BUYING_STORE_TO_BUYER.size = 4;

// 0x81b
PACKET.ZC.UPDATE_ITEM_FROM_BUYING_STORE =
	function PACKET_ZC_UPDATE_ITEM_FROM_BUYING_STORE(fp, end) {
		this.ITID = fp.readUShort();
		this.count = fp.readShort();
		this.limitZeny = fp.readLong();
	};
...
// 0x81c
PACKET.ZC.ITEM_DELETE_BUYING_STORE =
	function PACKET_ZC_ITEM_DELETE_BUYING_STORE(fp, end) {
		this.index = fp.readShort();
		this.count = fp.readShort();
		this.zeny = fp.readLong();
	};
...
// 0x820
PACKET.ZC.COSTUME_SPRITE_CHANGE = function PACKET_ZC_COSTUME_SPRITE_CHANGE(
	fp,
	end
) {
	this.GID = fp.readULong();
...
// 0x824
PACKET.ZC.FAILED_TRADE_BUYING_STORE_TO_SELLER =
	function PACKET_ZC_FAILED_TRADE_BUYING_STORE_TO_SELLER(fp, end) {
		this.Result = fp.readShort();
		this.ITID = fp.readUShort();
	};
...
// 0x828
PACKET.HC.DELETE_CHAR3_RESERVED = function PACKET_HC_DELETE_CHAR3_RESERVED(
	fp,
	end
) {
	this.GID = fp.readULong();
...
// 0x82d
PACKET.HC.ACCEPT_ENTER_NEO_UNION_HEADER =
	function PACKET_HC_ACCEPT_ENTER_NEO_UNION_HEADER(fp, end) {
		this.TotalSlotNum = fp.readUChar();
		this.PremiumStartSlot = fp.readUChar();
		this.PremiumEndSlot = fp.readUChar();
		this.dummy1_beginbilling = fp.readChar();
...
// 0x82c
PACKET.HC.DELETE_CHAR3_CANCEL = function PACKET_HC_DELETE_CHAR3_CANCEL(
	fp,
	end
) {
	this.GID = fp.readULong();
...
// 0x836
PACKET.ZC.SEARCH_STORE_INFO_ACK = function PACKET_ZC_SEARCH_STORE_INFO_ACK(
	fp,
	end
) {
...
// 0x837
PACKET.ZC.SEARCH_STORE_INFO_FAILED =
	function PACKET_ZC_SEARCH_STORE_INFO_FAILED(fp, end) {
...
// 0x83a
PACKET.ZC.OPEN_SEARCH_STORE_INFO = function PACKET_ZC_OPEN_SEARCH_STORE_INFO(
	fp,
	end
) {
...
// 0x83d
PACKET.ZC.SSILIST_ITEM_CLICK_ACK = function PACKET_ZC_SSILIST_ITEM_CLICK_ACK(
	fp,
	end
) {
	this.x = fp.readShort();
...
// 0x840
PACKET.HC.NOTIFY_ACCESSIBLE_MAPNAME =
	function PACKET_HC_NOTIFY_ACCESSIBLE_MAPNAME(fp, end) {
...
// 0x859
PACKET.ZC.EQUIPWIN_MICROSCOPE_V2 = function PACKET_ZC_EQUIPWIN_MICROSCOPEV2(
	fp,
	end
) {
	this.characterName = fp.readString(NAME_LENGTH);
...
// 0x8b9
PACKET.HC.SECOND_PASSWD_LOGIN = function PACKET_HC_SECOND_PASSWD_LOGIN(
	fp,
	end
) {
...
// 0x8d0
PACKET.ZC.REQ_WEAR_EQUIP_ACK2 = function PACKET_ZC_REQ_WEAR_EQUIP_ACK2(
	fp,
	end
) {
	this.index = fp.readUShort();
...
// 0x8d1
PACKET.ZC.REQ_TAKEOFF_EQUIP_ACK2 = function PACKET_ZC_REQ_TAKEOFF_EQUIP_ACK2(
	fp,
	end
) {
	this.index = fp.readUShort();
...
// 0x8fe
PACKET.ZC.UPDATE_MISSION_HUNT2 = function PACKET_ZC_UPDATE_MISSION_HUNT2(
	fp,
	end
) {
...
// 0x906
PACKET.ZC.EQUIPWIN_MICROSCOPE_V3 = function PACKET_ZC_EQUIPWIN_MICROSCOPEV3(
	fp,
	end
) {
	this.characterName = fp.readString(NAME_LENGTH);
...
// 0x988
PACKET.ZC.NOTIFY_CLAN_CONNECTINFO = function PACKET_ZC_NOTIFY_CLAN_CONNECTINFO(
	fp,
	end
) {
...
// 0x992
PACKET.ZC.EQUIPMENT_ITEMLIST4 = function PACKET_ZC_EQUIPMENT_ITEMLIST4(
	fp,
	end
) {
	this.ItemInfo = (function () {
...
// 0x993
PACKET.ZC.CART_NORMAL_ITEMLIST4 = function PACKET_ZC_CART_NORMAL_ITEMLIST4(
	fp,
	end
) {
	this.ItemInfo = (function () {
...
// 0x994
PACKET.ZC.CART_EQUIPMENT_ITEMLIST4 =
	function PACKET_ZC_CART_EQUIPMENT_ITEMLIST4(fp, end) {
		this.ItemInfo = (function () {
			var i,
				count = ((end - fp.tell()) / 31) | 0,
				out = new Array(count);
...
// 0x995
PACKET.ZC.STORE_NORMAL_ITEMLIST4 = function PACKET_ZC_STORE_NORMAL_ITEMLIST4(
	fp,
	end
) {
	this.Name = fp.readString(NAME_LENGTH);
...
// 0x996
PACKET.ZC.STORE_EQUIPMENT_ITEMLIST4 =
	function PACKET_ZC_STORE_EQUIPMENT_ITEMLIST4(fp, end) {
		this.Name = fp.readString(NAME_LENGTH);
		this.ItemInfo = (function () {
			var i,
				count = ((end - fp.tell()) / 31) | 0,
...
// 0x997
PACKET.ZC.EQUIPWIN_MICROSCOPE_V4 = function PACKET_ZC_EQUIPWIN_MICROSCOPE_V4(
	fp,
	end
) {
	this.characterName = fp.readString(NAME_LENGTH);
...
// 0x99a
PACKET.ZC.ACK_TAKEOFF_EQUIP_V5 = function PACKET_ZC_ACK_TAKEOFF_EQUIP_V5(
	fp,
	end
) {
	this.index = fp.readUShort();
...
// 0x99d
PACKET.HC.ACCEPT_ENTER_NEO_UNION_LIST =
	function PACKET_HC_ACCEPT_ENTER_NEO_UNION_LIST(fp, end) {
		this.charInfo = PACKETVER.parseCharInfo(fp, end);
	};
...
// 0x9a8
PACKET.ZC.ACK_BANKING_DEPOSIT = function PACKET_ZC_ACK_BANKING_DEPOSIT(
	fp,
	end
) {
	this.reason = fp.readShort();
...
// 0x9aa
PACKET.ZC.ACK_BANKING_WITHDRAW = function PACKET_ZC_ACK_BANKING_WITHDRAW(
	fp,
	end
) {
	this.reason = fp.readShort();
...
PACKET.ZC.DELETEITEM_FROM_MCSTORE2 =
	function PACKET_ZC_DELETEITEM_FROM_MCSTORE2(fp, end) {
		this.index = fp.readShort();
		this.count = fp.readShort();
		this.GID = fp.readULong();
...
// 0xa70
PACKET.CZ.RANDOM_COMBINE_ITEM_UI_CLOSE =
	function PACKET_CZ_RANDOM_COMBINE_ITEM_UI_CLOSE() {};
...
// 0xAC3
PACKET.ZC.ACK_FAILED_ALL_RODEX_LIST =
	function PACKET_ZC_ACK_FAILED_ALL_RODEX_LIST(fp, end) {};
...
// 0x9f2
PACKET.ZC.ACK_ZENY_FROM_RODEX = function PACKET_ZC_ACK_ZENY_FROM_RODEX(
	fp,
	end
) {
	this.MailID = fp.readUInt64();
...
// 0x9f4
PACKET.ZC.ACK_ITEM_FROM_RODEX = function PACKET_ZC_ACK_ITEM_FROM_RODEX(
	fp,
	end
) {
	this.MailID = fp.readUInt64();
...
// 0xb3f
PACKET.ZC.ACK_ADD_ITEM_RODEX2 = function PACKET_ZC_ACK_ADD_ITEM_RODEX2(
	fp,
	end
) {
	this.result = fp.readUChar();
...
// 0xa07
PACKET.ZC.ACK_REMOVE_RODEX_ITEM = function PACKET_ZC_ACK_REMOVE_RODEX_ITEM(
	fp,
	end
) {
	this.result = fp.readUChar();
...
//0xa12
PACKET.ZC.ACK_OPEN_WRITE_RODEX = function PACKET_ZC_ACK_OPEN_WRITE_RODEX(
	fp,
	end
) {
...
// 0xa03
PACKET.CZ.REQ_CANCEL_WRITE_RODEX =
	function PACKET_CZ_REQ_CANCEL_WRITE_RODEX() {};
...
// 0xa13
PACKET.CZ.CHECK_RECEIVE_CHARACTER_NAME =
	function PACKET_CZ_CHECK_RECEIVE_CHARACTER_NAME() {
		this.name = "";
	};
...
// 0xa14
PACKET.ZC.CHECK_RECEIVE_CHARACTER_NAME =
	function PACKET_ZC_CHECK_RECEIVE_CHARACTER_NAME(fp, end) {
...
// 0xa51
PACKET.ZC.CHECK_RECEIVE_CHARACTER_NAME2 =
	function PACKET_ZC_CHECK_RECEIVE_CHARACTER_NAME2(fp, end) {
		this.CharID = fp.readULong();
		this.Job = fp.readUShort();
		this.level = fp.readUShort();
		this.name = fp.readString(NAME_LENGTH);
...
// 0x9fa
PACKET.ZC.UPDATE_MISSION_HUNT3 = function PACKET_ZC_UPDATE_MISSION_HUNT3(
	fp,
	end
) {
	this.questCount = fp.readShort();
...
// 0xa00
PACKET.ZC.SHORTCUT_KEY_LIST_V3 = function PACKET_ZC_SHORTCUT_KEY_LIST_V3(
	fp,
	end
) {
...
//0xa0d
PACKET.ZC.EQUIPMENT_ITEMLIST5 = function PACKET_ZC_EQUIPMENT_ITEMLIST5(
	fp,
	end
) {
	let option = new Struct("short index", "short value", "char param");
...
// 0xa10
PACKET.ZC.STORE_EQUIPMENT_ITEMLIST5 =
	function PACKET_ZC_STORE_EQUIPMENT_ITEMLIST5(fp, end) {
		let option = new Struct("short index", "short value", "char param");
...
// 0xa26
PACKET.ZC.REQ_ACH_REWARD_ACK = function PACKET_ZC_REQ_ACH_REWARD_ACK(
	fp,
	end
) {};
...
// 0xa2d
PACKET.ZC.EQUIPWIN_MICROSCOPE_V5 = function PACKET_ZC_EQUIPWIN_MICROSCOPE_V5(
	fp,
	end
) {
	this.characterName = fp.readString(NAME_LENGTH);
...
// 0xa43
PACKET.ZC.ADD_MEMBER_TO_GROUP3 = function PACKET_ZC_ADD_MEMBER_TO_GROUP3(
	fp,
	end
) {
	this.AID = fp.readULong();
...
// 0xa4e
PACKET.ZC.RANDOM_COMBINE_ITEM_UI_OPEN =
	function PACKET_ZC_RANDOM_COMBINE_ITEM_UI_OPEN(fp, end) {
		this.itemId =
			PACKETVER.value >= 20181121 ? fp.readLong() : fp.readShort();
	};
PACKET.ZC.RANDOM_COMBINE_ITEM_UI_OPEN.size =
	PACKETVER.value >= 20181121 ? 6 : 4;

// 0xa4f
PACKET.CZ.REQ_RANDOM_COMBINE_ITEM =
	function PACKET_CZ_REQ_RANDOM_COMBINE_ITEM() {
		this.itemId = 0;
		this.items = [];
	};
PACKET.CZ.REQ_RANDOM_COMBINE_ITEM.prototype.build = function () {
	...
	PACKETVER.value >= 20181121
		...
		: pkt_buf.writeShort(this.itemId);
...
// 0xa50
PACKET.ZC.ACK_RANDOM_COMBINE_ITEM = function PACKET_ZC_ACK_RANDOM_COMBINE_ITEM(
	fp,
	end
) {
	this.result = fp.readShort();
...
// 0xa97
PACKET.CZ.REQ_WEAR_SWITCHEQUIP_ADD =
	function PACKET_CZ_REQ_WEAR_SWITCHEQUIP_ADD() {
		this.index = 0;
		this.wearLocation = 0;
	};
...
// 0xa98
PACKET.ZC.REQ_WEAR_SWITCHEQUIP_ADD_RESULT =
	function PACKET_ZC_REQ_WEAR_SWITCHEQUIP_ADD_RESULT(fp, end) {
		this.index = fp.readUShort();
		this.location = fp.readULong();
		this.flag =
			PACKETVER.value > 20170502 ? fp.readUShort() : fp.readULong();
	};
PACKET.ZC.REQ_WEAR_SWITCHEQUIP_ADD_RESULT.size =
	PACKETVER.value > 20170502 ? 10 : 12;

// 0xa99
PACKET.CZ.REQ_WEAR_SWITCHEQUIP_REMOVE =
	function PACKET_CZ_REQ_WEAR_SWITCHEQUIP_REMOVE() {
		this.index = 0;
		this.wearLocation = 0;
	};
...
// 0xa9a
PACKET.ZC.REQ_WEAR_SWITCHEQUIP_REMOVE_RESULT =
	function PACKET_ZC_REQ_WEAR_SWITCHEQUIP_REMOVE_RESULT(fp, end) {
		this.index = fp.readUShort();
		this.location = fp.readULong();
...
//0xa9b
PACKET.ZC.SEND_SWAP_EQUIPITEM_INFO =
	function PACKET_ZC_SEND_SWAP_EQUIPITEM_INFO(fp, end) {
		this.ItemInfo = (function () {
			var i,
				count = ((end - fp.tell()) / 6) | 0,
				out = new Array(count);
...
PACKET.ZC.REQ_FULLSWITCH_RESULT = function PACKET_ZC_REQ_FULLSWITCH_RESULT(
	fp,
	end
) {
...
// 0xaa2
PACKET.ZC.REFINING_MATERIAL_LIST = function PACKET_ZC_REFINING_MATERIAL_LIST(
	fp,
	end
) {
	this.itemIndex = fp.readShort();
...
// 0xada
PACKET.ZC.BROADCAST_ITEMREFINING_RESULT =
	function PACKET_ZC_BROADCAST_ITEMREFINING_RESULT(fp, end) {
		this.charName = fp.readString(NAME_LENGTH);
		this.itemId =
			PACKETVER.value >= 20181121 ? fp.readULong() : fp.readUShort();
...
PACKET.ZC.BROADCAST_ITEMREFINING_RESULT.size =
	PACKETVER.value >= 20181121 ? 32 : 30;
...
// 0xade
PACKET.ZC.RECOVER_PENALTY_OVERWEIGHT =
	function PACKET_ZC_RECOVER_PENALTY_OVERWEIGHT(fp, end) {
...
// 0xae4
PACKET.ZC.ADD_MEMBER_TO_GROUP4 = function PACKET_ZC_ADD_MEMBER_TO_GROUP4(
	fp,
	end
) {
	this.AID = fp.readULong();
...
// 0xafe
PACKET.ZC.UPDATE_MISSION_HUNT4 = function PACKET_ZC_UPDATE_MISSION_HUNT4(
	fp,
	end
) {
	this.questCount = fp.readShort();
...
//0xb03
PACKET.ZC.EQUIPWIN_MICROSCOPE_V6 = function PACKET_ZC_EQUIPWIN_MICROSCOPE_V6(
	fp,
	end
) {
	this.characterName = fp.readString(NAME_LENGTH);
...
//0xb08
PACKET.ZC.SPLIT_SEND_ITEMLIST_SET = function PACKET_SPLIT_SEND_ITEMLIST_SET(
	fp,
	end
) {
...
//0xb09
PACKET.ZC.SPLIT_SEND_ITEMLIST_NORMAL =
	function PACKET_ZC_SPLIT_SEND_ITEMLIST_NORMAL(fp, end) {
		this.invType = fp.readUChar();
...
//0xb0a
PACKET.ZC.SPLIT_SEND_ITEMLIST_EQUIP =
	function PACKET_ZC_SPLIT_SEND_ITEMLIST_EQUIP(fp, end) {
		this.invType = fp.readUChar();
		let option = new Struct("short index", "short value", "char param");
...
//0xb0b
PACKET.ZC.SPLIT_SEND_ITEMLIST_RESULT =
	function PACKET_ZC_SPLIT_SEND_ITEMLIST_RESULT(fp, end) {
		this.invType = fp.readUChar();
...
// 0xb14
PACKET.CZ.REQ_OPEN_MSGBOX_EXTEND_BODYITEM_SIZE =
	function PACKET_CZ_REQ_OPEN_MSGBOX_EXTEND_BODYITEM_SIZE() {};
...
// 0xb15
PACKET.ZC.ACK_OPEN_MSGBOX_EXTEND_BODYITEM_SIZE =
	function PACKET_ZC_ACK_OPEN_MSGBOX_EXTEND_BODYITEM_SIZE(fp, end) {
		this.result = fp.readUChar();
		this.itemId = fp.readULong();
	};
...
// 0xb16
PACKET.CZ.REQ_EXTEND_BODYITEM_SIZE =
	function PACKET_CZ_REQ_EXTEND_BODYITEM_SIZE() {};
...
// 0xb17
PACKET.ZC.ACK_EXTEND_BODYITEM_SIZE =
	function PACKET_ZC_ACK_EXTEND_BODYITEM_SIZE(fp, end) {
		this.result = fp.readUChar();
	};
PACKET.ZC.ACK_EXTEND_BODYITEM_SIZE.size = 3;

// 0xb18
PACKET.ZC.EXTEND_BODYITEM_SIZE = function PACKET_ZC_EXTEND_BODYITEM_SIZE(
	fp,
	end
) {
	this.type = fp.readUShort();
...
// 0xb19
PACKET.CZ.CLOSE_MSGBOX_EXTEND_BODYITEM_SIZE =
	function PACKET_CZ_CLOSE_MSGBOX_EXTEND_BODYITEM_SIZE() {};
...
// 0xb20
PACKET.ZC.SHORTCUT_KEY_LIST_V4 = function PACKET_ZC_SHORTCUT_KEY_LIST_V4(
	fp,
	end
) {
...
//0xb37
PACKET.ZC.EQUIPWIN_MICROSCOPE_V7 = function PACKET_ZC_EQUIPWIN_MICROSCOPE_V7(
	fp,
	end
) {
	this.characterName = fp.readString(NAME_LENGTH);
...
//0xb39
PACKET.ZC.SPLIT_SEND_ITEMLIST_EQUIP2 =
	function PACKET_ZC_SPLIT_SEND_ITEMLIST_EQUIP2(fp, end) {
		this.invType = fp.readUChar();
		let option = new Struct("short index", "short value", "char param");
		let item_size = 68;
		this.ItemInfo = (function () {
...
// 0xb3d
PACKET.ZC.PC_PURCHASE_ITEMLIST_FROMMC3 =
	function PACKET_ZC_PC_PURCHASE_ITEMLIST_FROMMC3(fp, end) {
		this.AID = fp.readULong();
		this.UniqueID = fp.readULong();
		this.itemList = (function () {
			var i,
			...
			count =
				(end - fp.tell()) /
				(4 + 2 + 2 + 1 + 4 + 1 + 1 + 16 + 25 + 4 + 2 + 1 + 1); //Item options 25 bytes, (location viewSprite), itemId use Long now, grade
...
// 0xb40
PACKET.ZC.PC_PURCHASE_MYITEMLIST2 = function PACKET_ZC_PC_PURCHASE_MYITEMLIST2(
	fp,
	end
) {
	let option = new Struct("short index", "short value", "char param");
...
// 0xb72
PACKET.HC.ACCEPT_ENTER_NEO_UNION_LIST2 =
	function PACKET_HC_ACCEPT_ENTER_NEO_UNION_LIST2(fp, end) {
		this.charInfo = PACKETVER.parseCharInfo(fp, end);
	};
...
// 0xb77
PACKET.ZC.PC_PURCHASE_ITEMLIST2 = function PACKET_ZC_PC_PURCHASE_ITEMLIST2(
	fp,
	end
) {
	this.itemList = (function () {
...
// 0xce
PACKET.CZ.DISCONNECT_ALL_CHARACTER =

...
function UIComponent(name, htmlText, cssText) {
  ...
  // Add the CSS to the head when the component is created
 ...
 * @param {string} css
 */
UIComponent.prototype.addCSS = function(css) {
...
UIComponent.prototype.prepare = function prepare() {
  ...
  if (this.mouseMode === UIComponent.MouseMode.STOP) {
    ...
    element.mouseenter(function() {
      if (_enter === 0) {
        ...
        if (_intersect) {
          ...
          Renderer.EntityManager.setOverEntity(null);
        }
      }
    });
    ...
    // Custom fix for firefox, mouseleave isn't trigger quando o elemento é removido do corpo, caso de teste: http://jsfiddle.net/7h4sj/
...
/**
 * Enable a type (keydown é o único suportado até agora)
 *
...
/**
 * Disable a type (keydown é o único suportado até agora)
 *
